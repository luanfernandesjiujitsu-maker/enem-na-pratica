...
const PROVOES = [
  {
    ...
    questoes: [
      ...
      { id: "p1q15", n: 3, enunciado: "A globalização intensificou:", alternativas: ["A) O isolamento dos países", "B) A integração econômica e fluxos de informação", "C) O fim do comércio marítimo", "D) A volta ao sistema de troca (escambo)", "E) A ditadura monárquica global"], gabarito: "B", explicacao: "Conectividade mundial interdependente." },
